...
**LeaderBoard** is an application to represent scores
...
- [Live Demo Link](https://aqurds.github.io/mv-leaderboard/dist/)
...
```sh
  cd my-folder
  git clone https://github.com/Aqurds/mv-leaderboard.git
```
...
- **Add innterface to see details of each top scorer**
...
Feel free to check the [issues page](https://github.com/Aqurds/mv-leaderboard/issues).
